...
urlpatterns = patterns(
    ...
    url(r'^staff/(?P<uid>\d+)/delete/$', views.offer_delete_ajax, name='offer_delete_ajax'),
    ...
    url(r'^classroom/(?P<cid>\d+)/template/$', views.calendar_classroom_template, name='classroom_template'),
